							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											<img src="upload/<?php echo $data[0]['image']?>" alt="" />
										...
										<div class="product-overlay">
											<div class="overlay-content">
												<h2><?php echo $value['price'] ?></h2>
												<p><?php echo $value['title'] ?></p>
												<a id="<?php echo $value['id'] ?>" name ="addCart" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
											</div>
										</div>
								</div>
								<div class="choose">
	...
	<script type="text/javascript">
		$(".add-to-cart").click(function(){
			...
			$.ajax({
				...
				url: "showdata.php",// gọi đến file server showdata.php để xử lý
				data: {
					getId: getId
				},	
